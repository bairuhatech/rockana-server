const ToUserCorporate = async (created: any) => {
  try {
    let obj = {
      to: created?.email,
          ...
          >
            ...
            <div style="text-align: left; padding: 20px">
              ...
              <p style="padding-left: 10px">
                Congratulations! Your corporate seller registration on NextMe for store ${created?.store_name} is successful.
              </p>
              <p style="padding-left: 10px">
