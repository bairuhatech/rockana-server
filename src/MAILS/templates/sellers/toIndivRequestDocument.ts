const ToIndividualRequestDocument = async (created: any) => {
  try {
    let obj = {
      to: created?.to,
            ...
            >
              ...
              <div style="text-align: left; padding: 20px">
                ...
                <p style="padding-left: 10px">  
                  We need more documents to process your request for store. Please provide the documents mentioned
                </p>
                <ul>
                  <li style="padding-left: 10px">
                    <strong>Requirements:</strong> ${created?.subject}
                  </li>
...
export { ToIndividualRequestDocument };
